# Getting help with razip

Thanks for using razip. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the razip package](https://github.com/natverse/razip/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/razip/issues/new).
* If you're not sure:
